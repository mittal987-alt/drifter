...
CATEGORY_MAPPINGS = [
    ...
    (re.compile(r"\b(finance|credit|invest|stock|trading|crypto|bank|money|upstox|slice|commerce|shopping|bonds)\b", re.I), "Finance & Investing"),
    (re.compile(r"\b(ai|llm|gpt|gemini|openai|agent|agents|python|coding|react|javascript|typescript|software|developer|machine learning)\b", re.I), "AI & Software Engineering"),
    (re.compile(r"\b(music|song|spotify|soundtrack|album|track|artist|audio|soundscape|beats|phonk)\b", re.I), "Music & Audio"),
    (re.compile(r"\b(film|movie|cinema|trailer|documentary|entertainment|podcast|show|media)\b", re.I), "Entertainment & Media"),
